...
$app->get('/lstpagos/:idempresa/:flimite(/:idmoneda)', function($idempresa, $flimite, $idmoneda = 0){
    ...
    $query.= "WHERE (a.totfact - (a.isr + IFNULL(c.montopagado, 0.00) + IFNULL(e.rebajado, 0.00))) > 0.00 AND a.idempresa = $idempresa AND YEAR(a.fechapago) >= 2022 AND a.alcontado = 0 AND a.idtipofactura < 7 ";
