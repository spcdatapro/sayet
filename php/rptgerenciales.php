...
$app->post('/control_ingresos', function () {
    ...
    $query = "SELECT 
                ...
                d.ingreso - (SELECT SUM(dc.monto) FROM detcobroventa dc INNER JOIN recibocli reci ON dc.idrecibocli = reci.id WHERE dc.idfactura = d.idfactura AND reci.fecha != '$d->fechastr'))), 0), 2) AS ingreso,
                a.monto AS deposito,
            ...
            FROM
                ...
                (SELECT 
                    ...
                    b.id AS idfactura,
                        ...
                        IF(a.idrecibocli IN(23197, 23196), 354.49, 0.00) AS pago_extra,
