            ...
            FROM
                ...
                (SELECT 
                    a.idrecibocli,
                        ...
                        SUM(IF(b.id = 34356, b.subtotal - a.monto -2000 - b.retisr, IF(b.pagada = 1, IF(a.monto + b.retisr + b.retiva > b.subtotal, b.subtotal, (a.monto + b.retisr + b.retiva)), IF(b.idmonedafact = 2, b.subtotalcnv, b.subtotal)))) AS ingreso,
