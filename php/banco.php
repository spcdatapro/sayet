...
$app->get('/lstbancosmt940(/:idempresa)', function($idempresa = 0) {
    $db = new dbcpm();
    $query = "SELECT a.id, e.id AS idempresa, e.nomempresa AS empresa, e.abreviatura AS abreviaempresa, b.id AS idcuentac, CONCAT('(', b.codigo, ') ', b.nombrecta) AS nombrecta,
            ...
            WHERE a.mt940 IS NOT NULL ";
    $query.= $idempresa > 0 ? "AND a.idempresa = $idempresa " : "";
    $query.= "AND a.debaja = 0 ORDER BY e.ordensumario, a.nombre";
