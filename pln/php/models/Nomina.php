...
class Nomina extends Principal
{
	...
	public function actualizar_saldo_prestamos($args=[])
	{
		...
		if (count($descprestamo) > 0 && isset($nomina->descprestamo)) {
...
EOT;
		...
		foreach ($res as $row) {
			...
			$tmp = [
				...
				'tanticipo'        => 'Anticipos:',
				'vanticipo'        => (isset($args['recibo']) || $dia == 15) ? $row->anticipo : $row->otrosingresos,
	...
	public function get_cabecera($args = [])
	{
		...
		$anticipo = $args['dia'] == 15 ? "Anticipos" : "Otros";
