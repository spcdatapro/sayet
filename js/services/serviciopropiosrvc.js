(function(){
    ...
    serviciopropiosrvc.factory('servicioPropioSrvc', ['comunFact', function(comunFact){
        ...
        return {
            ...
            getLectura: function(idusuario, mes, anio, actualizar, idproyecto){
                return comunFact.doGET(urlBase + '/lectura/' + idusuario + '/' + mes + '/' + anio + '/' + actualizar + (idproyecto ? ('/' + idproyecto) : ''));
            },
            lstProyectosUsuario: function(idusuario){
                return comunFact.doGET(urlBase + '/proyusr/' + idusuario);
            },
            existe: function(mes, anio) {
                return comunFact.doGET(urlBase + '/existe/' + mes + '/' + anio);
            }
        };
    }]);
