(function () {
    ...
    rptchqaprobctrl.controller('rptChequesAprobacionCtrl', ['$scope', 'empresaSrvc', 'bancoSrvc', 'monedaSrvc', '$window', 'authSrvc', '$filter', function ($scope, empresaSrvc, bancoSrvc, monedaSrvc, $window, authSrvc, $filter) {
        ...
        authSrvc.getSession().then(function (usuario) {
            ...
            $scope.loadBancos(usuario.workingon.toString());
