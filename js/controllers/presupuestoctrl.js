(function(){
    ...
    presupuestoctrl.controller('presupuestoCtrl', ['$scope', 'presupuestoSrvc', '$confirm', 'proyectoSrvc', 'empresaSrvc', 'tipogastoSrvc', 'monedaSrvc', '$filter', 'authSrvc', 'proveedorSrvc', 'toaster', '$uibModal', 'desktopNotification', 'jsReportSrvc', '$window', 'tranBancSrvc', function($scope, presupuestoSrvc, $confirm, proyectoSrvc, empresaSrvc, tipogastoSrvc, monedaSrvc, $filter, authSrvc, proveedorSrvc, toaster, $uibModal, desktopNotification, jsReportSrvc, $window, tranBancSrvc){
        ...
        $scope.getLstPresupuestos = function(){
        ...
        $scope.delPresupuesto = function(obj){
            $confirm({text: '¿Esta seguro(a) de eliminar el presupuesto No. ' + obj.id +'?', title: 'Eliminar presupuesto', ok: 'Sí', cancel: 'No'}).then(function() {
                presupuestoSrvc.editRow({id: obj.id}, 'd').then(function(){ $scope.getLstPresupuestos(); $scope.resetPresupuesto(); });
            });
        };
